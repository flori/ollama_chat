# -*- encoding: utf-8 -*-
# stub: ollama_chat 0.0.46 ruby lib

Gem::Specification.new do |s|
  s.name = "ollama_chat".freeze
  s.version = "0.0.46".freeze
